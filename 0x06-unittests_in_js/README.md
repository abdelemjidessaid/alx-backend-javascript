...
- Inside the same `describe`, create 2 tests:
  - The first test will call `sendPaymentRequestToAPI` with 100, and 20:  
     _ Verify that the console is logging the string `The total is: 120`  
     _ Verify that the console is only called once
  - The second test will call `sendPaymentRequestToAPI` with 10, and 10:  
     _ Verify that the console is logging the string `The total is: 20`  
     _ Verify that the console is only called once
